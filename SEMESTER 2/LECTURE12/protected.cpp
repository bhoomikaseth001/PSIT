...
-> Accessing protected members: 
    the derivred class can access the protected member (protetVar) unherited from base class. It uses this access to modify protected variable(protectedVar) in the modifyProtectedVar function
-> Function inheritace : 
